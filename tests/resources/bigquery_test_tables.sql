...
(BIGNUMERIC '223456789012345678901234567890','Row 2'
,987654321012345678
,BIGNUMERIC '12345678901234567890123456789012345678'
,NUMERIC '12345678901234567890123456789.123456789'
,BIGNUMERIC '12345678.123456789012345678901234567890'
,987654321012345678,12345678901234567.1),
(BIGNUMERIC '323456789012345678901234567890','Row 3'
,987654321012345678
,BIGNUMERIC '12345678901234567890123456789012345678'
,NUMERIC '12345678901234567890123456789.123456789'
,BIGNUMERIC '12345678.123456789012345678901234567890'
,987654321012345678,12345678901234567.1),
(BIGNUMERIC '423456789012345678901234567890','Row 4'
,987654321012345678
,BIGNUMERIC '12345678901234567890123456789012345678'
,NUMERIC '12345678901234567890123456789.123456789'
,BIGNUMERIC '12345678.123456789012345678901234567890'
,987654321012345678,12345678901234567.1),
(BIGNUMERIC '523456789012345678901234567890','Row 5'
,987654321012345678
,BIGNUMERIC '12345678901234567890123456789012345678'
,NUMERIC '12345678901234567890123456789.123456789'
,BIGNUMERIC '12345678.123456789012345678901234567890'
...
,   col_dbclob      STRING
,   col_blob        BYTES
-- TODO Switch the two "_bit" columns to BYTES after issue-1655 is complete.
,   col_char_bit    STRING
...
,'Hello CLOB','Hello NVARCHAR','A ','Hello NCLOB','Hello DBCLOB',CAST('Hello BLOB' AS BYTES)
,'ABC','DEF'
-- TODO Replace ABC,DEF line above with UUID hex line below once issue-1655 is complete.
--,FROM_HEX('550E8400E29B41D4A716446655440000'),FROM_HEX('550E8400E29B41D4A716446655440000')
,'GHI','JKL'
...
,'Hello CLOB2','Hello NVARCHAR2','B ','Hello NCLOB2','Hello DBCLOB2',CAST('Hello BLOB2' AS BYTES)
,'ABC','DEF'
-- TODO Replace ABC,DEF line above with UUID hex line below once issue-1655 is complete.
...
CREATE OR REPLACE TABLE `pso_data_validator`.`dvt_reserved_word_columns` (
  id         INT64
-- SQL tokens
, `SELECT`   STRING
, `COLUMN`   STRING
