...
CREATE OR REPLACE TABLE test_generate_partitions_v2 (
        course_id STRING(24),
        quarter_id INTEGER,
...
DROP TABLE PSO_DATA_VALIDATOR.PUBLIC.DVT_LARGE_DECIMALS;
CREATE TABLE PSO_DATA_VALIDATOR.PUBLIC.DVT_LARGE_DECIMALS
...
COMMENT ON TABLE PSO_DATA_VALIDATOR.PUBLIC.dvt_large_decimals IS 'Large decimals integration test table';

INSERT INTO PSO_DATA_VALIDATOR.PUBLIC.DVT_LARGE_DECIMALS VALUES
...
DROP TABLE PSO_DATA_VALIDATOR.PUBLIC.DVT_DATETIME_ID;
CREATE TABLE PSO_DATA_VALIDATOR.PUBLIC.DVT_DATETIME_ID
(   id          DATETIME NOT NULL PRIMARY KEY
,   other_data  VARCHAR(100)
);
COMMENT ON TABLE PSO_DATA_VALIDATOR.PUBLIC.DVT_DATETIME_ID IS 'Integration test table used to test datetime pk matching.';
INSERT INTO PSO_DATA_VALIDATOR.PUBLIC.DVT_DATETIME_ID VALUES
...
,TIMESTAMP'1000-01-01 00:00:00',TIMESTAMP'1970-01-01 00:00:00',TIMESTAMP'9999-12-31 23:59:59',DATETIME'4712-12-31 23:23:59');
INSERT INTO PSO_DATA_VALIDATOR.PUBLIC.DVT_TRICKY_DATES (id) VALUES (2);
