...
EXPECTED_PARTITION_FILTER = [
    [
        ...
        " (quarter_id != 1111) AND ((`course_id` > 'ALG004') OR ((`course_id` = 'ALG004') AND ((`quarter_id` > 5678) OR ((`quarter_id` = 5678) AND ((`registration_date` > '2023-08-23') OR ((`registration_date` = '2023-08-23') AND (`approved` >= FALSE))))))) AND ((`course_id` < 'St. Edwards') OR ((`course_id` = 'St. Edwards') AND ((`quarter_id` < 1234) OR ((`quarter_id` = 1234) AND ((`registration_date` < '1969-07-20') OR ((`registration_date` = '1969-07-20') AND (`approved` < TRUE)))))))",
        " (quarter_id != 1111) AND ((`course_id` > 'St. Edwards') OR ((`course_id` = 'St. Edwards') AND ((`quarter_id` > 1234) OR ((`quarter_id` = 1234) AND ((`registration_date` > '1969-07-20') OR ((`registration_date` = '1969-07-20') AND (`approved` >= TRUE))))))) AND ((`course_id` < 'St. Johns') OR ((`course_id` = 'St. Johns') AND ((`quarter_id` < 1234) OR ((`quarter_id` = 1234) AND ((`registration_date` < '1969-07-20') OR ((`registration_date` = '1969-07-20') AND (`approved` < TRUE)))))))",
        " (quarter_id != 1111) AND ((`course_id` > 'St. Johns') OR ((`course_id` = 'St. Johns') AND ((`quarter_id` > 1234) OR ((`quarter_id` = 1234) AND ((`registration_date` > '1969-07-20') OR ((`registration_date` = '1969-07-20') AND (`approved` >= TRUE))))))) AND ((`course_id` < 'St. Judes') OR ((`course_id` = 'St. Judes') AND ((`quarter_id` < 1234) OR ((`quarter_id` = 1234) AND ((`registration_date` < '1969-07-20') OR ((`registration_date` = '1969-07-20') AND (`approved` < FALSE)))))))",
        " (quarter_id != 1111) AND ((`course_id` > 'St. Judes') OR ((`course_id` = 'St. Judes') AND ((`quarter_id` > 1234) OR ((`quarter_id` = 1234) AND ((`registration_date` > '1969-07-20') OR ((`registration_date` = '1969-07-20') AND (`approved` >= FALSE))))))) AND ((`course_id` < 'St. Pauls') OR ((`course_id` = 'St. Pauls') AND ((`quarter_id` < 1234) OR ((`quarter_id` = 1234) AND ((`registration_date` < '1969-07-20') OR ((`registration_date` = '1969-07-20') AND (`approved` < FALSE)))))))",
        " (quarter_id != 1111) AND ((`course_id` > 'St. Pauls') OR ((`course_id` = 'St. Pauls') AND ((`quarter_id` > 1234) OR ((`quarter_id` = 1234) AND ((`registration_date` > '1969-07-20') OR ((`registration_date` = '1969-07-20') AND (`approved` >= FALSE)))))))",
    ],
    [
        " (quarter_id != 1111) AND ((`course_id` < 'ALG001') OR ((`course_id` = 'ALG001') AND ((`quarter_id` < 5678) OR ((`quarter_id` = 5678) AND ((`registration_date` < '2023-08-23') OR ((`registration_date` = '2023-08-23') AND (`approved` < TRUE)))))))",
        " (quarter_id != 1111) AND ((`course_id` > 'ALG001') OR ((`course_id` = 'ALG001') AND ((`quarter_id` > 5678) OR ((`quarter_id` = 5678) AND ((`registration_date` > '2023-08-23') OR ((`registration_date` = '2023-08-23') AND (`approved` >= TRUE))))))) AND ((`course_id` < 'ALG002  t0.') OR ((`course_id` = 'ALG002  t0.') AND ((`quarter_id` < 5678) OR ((`quarter_id` = 5678) AND ((`registration_date` < '2023-08-23') OR ((`registration_date` = '2023-08-23') AND (`approved` < TRUE)))))))",
