...
EXPECTED_PARTITION_FILTER = [
    [
        ' (quarter_id <> 1111) AND (("course_id" < \'ALG001\') OR (("course_id" = \'ALG001\') AND (("quarter_id" < 5678) OR (("quarter_id" = 5678) AND ("registration_date" < \'2023-08-23\')))))',
        ' (quarter_id <> 1111) AND (("course_id" > \'ALG001\') OR (("course_id" = \'ALG001\') AND (("quarter_id" > 5678) OR (("quarter_id" = 5678) AND ("registration_date" >= \'2023-08-23\'))))) AND (("course_id" < \'ALG002  t0.\') OR (("course_id" = \'ALG002  t0.\') AND (("quarter_id" < 5678) OR (("quarter_id" = 5678) AND ("registration_date" < \'2023-08-23\')))))',
        ' (quarter_id <> 1111) AND (("course_id" > \'ALG002  t0.\') OR (("course_id" = \'ALG002  t0.\') AND (("quarter_id" > 5678) OR (("quarter_id" = 5678) AND ("registration_date" >= \'2023-08-23\'))))) AND (("course_id" < \'ALG003\') OR (("course_id" = \'ALG003\') AND (("quarter_id" < 5678) OR (("quarter_id" = 5678) AND ("registration_date" < \'1969-07-20\')))))',
        ' (quarter_id <> 1111) AND (("course_id" > \'ALG003\') OR (("course_id" = \'ALG003\') AND (("quarter_id" > 5678) OR (("quarter_id" = 5678) AND ("registration_date" >= \'1969-07-20\'))))) AND (("course_id" < \'ALG004\') OR (("course_id" = \'ALG004\') AND (("quarter_id" < 5678) OR (("quarter_id" = 5678) AND ("registration_date" < \'1969-07-20\')))))',
        ' (quarter_id <> 1111) AND (("course_id" > \'ALG004\') OR (("course_id" = \'ALG004\') AND (("quarter_id" > 5678) OR (("quarter_id" = 5678) AND ("registration_date" >= \'1969-07-20\'))))) AND (("course_id" < \'St. Edward\\\'s\') OR ((t0."course_id" = \'St. Edward\\\'s\') AND (("quarter_id" < 1234) OR (("quarter_id" = 1234) AND ("registration_date" < \'2023-08-23\')))))',
        ' (quarter_id <> 1111) AND (("course_id" > \'St. Edward\\\'s\') OR ((t0."course_id" = \'St. Edward\\\'s\') AND (("quarter_id" > 1234) OR (("quarter_id" = 1234) AND ("registration_date" >= \'2023-08-23\'))))) AND (("course_id" < \'St. John\\\'s\') OR ((t0."course_id" = \'St. John\\\'s\') AND (("quarter_id" < 1234) OR (("quarter_id" = 1234) AND ("registration_date" < \'2023-08-23\')))))',
        ' (quarter_id <> 1111) AND (("course_id" > \'St. John\\\'s\') OR ((t0."course_id" = \'St. John\\\'s\') AND (("quarter_id" > 1234) OR (("quarter_id" = 1234) AND ("registration_date" >= \'2023-08-23\'))))) AND (("course_id" < \'St. Jude\\\'s\') OR ((t0."course_id" = \'St. Jude\\\'s\') AND (("quarter_id" < 1234) OR (("quarter_id" = 1234) AND ("registration_date" < \'1969-07-20\')))))',
        ' (quarter_id <> 1111) AND (("course_id" > \'St. Jude\\\'s\') OR ((t0."course_id" = \'St. Jude\\\'s\') AND (("quarter_id" > 1234) OR (("quarter_id" = 1234) AND ("registration_date" >= \'1969-07-20\'))))) AND (("course_id" < \'St. Paul\\\'s\') OR ((t0."course_id" = \'St. Paul\\\'s\') AND (("quarter_id" < 1234) OR (("quarter_id" = 1234) AND ("registration_date" < \'1969-07-20\')))))',
        ' (quarter_id <> 1111) AND (("course_id" > \'St. Paul\\\'s\') OR ((t0."course_id" = \'St. Paul\\\'s\') AND (("quarter_id" > 1234) OR (("quarter_id" = 1234) AND ("registration_date" >= \'1969-07-20\')))))',
    ],
    [
        ' (quarter_id <> 1111) AND (("course_id" < \'ALG001\') OR (("course_id" = \'ALG001\') AND (("quarter_id" < 5678) OR (("quarter_id" = 5678) AND ("registration_date" < \'2023-08-23\')))))',
        ' (quarter_id <> 1111) AND (("course_id" > \'ALG001\') OR (("course_id" = \'ALG001\') AND (("quarter_id" > 5678) OR (("quarter_id" = 5678) AND ("registration_date" >= \'2023-08-23\'))))) AND (("course_id" < \'ALG002  t0.\') OR (("course_id" = \'ALG002  t0.\') AND (("quarter_id" < 5678) OR (("quarter_id" = 5678) AND ("registration_date" < \'2023-08-23\')))))',
...
def test_generate_partitions(tmp_path: pathlib.Path):
    ...
    partition_table_test(
        ...
        pk="course_id,quarter_id,registration_date",
