...
EXPECTED_PARTITION_FILTER = [
    [
        '(course_id LIKE \'ALG%\') AND (("course_id" < \'ALG001\') OR (("course_id" = \'ALG001\') AND (("quarter_id" < 1234) OR (("quarter_id" = 1234) AND (("recd_timestamp" < \'2023-08-26T16:00:00\') OR (("recd_timestamp" = \'2023-08-26T16:00:00\') AND (("registration_date" < \'2023-08-23\') OR (("registration_date" = \'2023-08-23\') AND ("approved" < 1)))))))))',
        '(course_id LIKE \'ALG%\') AND (("course_id" > \'ALG001\') OR (("course_id" = \'ALG001\') AND (("quarter_id" > 1234) OR (("quarter_id" = 1234) AND (("recd_timestamp" > \'2023-08-26T16:00:00\') OR (("recd_timestamp" = \'2023-08-26T16:00:00\') AND (("registration_date" > \'2023-08-23\') OR (("registration_date" = \'2023-08-23\') AND ("approved" >= 1))))))))) AND (("course_id" < \'ALG001\') OR (("course_id" = \'ALG001\') AND (("quarter_id" < 5678) OR (("quarter_id" = 5678) AND (("recd_timestamp" < \'2023-08-26T16:00:00\') OR (("recd_timestamp" = \'2023-08-26T16:00:00\') AND (("registration_date" < \'2023-08-23\') OR (("registration_date" = \'2023-08-23\') AND ("approved" < 1)))))))))',
        '(course_id LIKE \'ALG%\') AND (("course_id" > \'ALG001\') OR (("course_id" = \'ALG001\') AND (("quarter_id" > 5678) OR (("quarter_id" = 5678) AND (("recd_timestamp" > \'2023-08-26T16:00:00\') OR (("recd_timestamp" = \'2023-08-26T16:00:00\') AND (("registration_date" > \'2023-08-23\') OR (("registration_date" = \'2023-08-23\') AND ("approved" >= 1))))))))) AND (("course_id" < \'ALG002\') OR (("course_id" = \'ALG002\') AND (("quarter_id" < 1234) OR (("quarter_id" = 1234) AND (("recd_timestamp" < \'2023-08-26T16:00:00\') OR (("recd_timestamp" = \'2023-08-26T16:00:00\') AND (("registration_date" < \'2023-08-23\') OR (("registration_date" = \'2023-08-23\') AND ("approved" < 1)))))))))',
        '(course_id LIKE \'ALG%\') AND (("course_id" > \'ALG002\') OR (("course_id" = \'ALG002\') AND (("quarter_id" > 1234) OR (("quarter_id" = 1234) AND (("recd_timestamp" > \'2023-08-26T16:00:00\') OR (("recd_timestamp" = \'2023-08-26T16:00:00\') AND (("registration_date" > \'2023-08-23\') OR (("registration_date" = \'2023-08-23\') AND ("approved" >= 1))))))))) AND (("course_id" < \'ALG002  t0.\') OR (("course_id" = \'ALG002  t0.\') AND (("quarter_id" < 5678) OR (("quarter_id" = 5678) AND (("recd_timestamp" < \'2023-08-26T16:00:00\') OR (("recd_timestamp" = \'2023-08-26T16:00:00\') AND (("registration_date" < \'2023-08-23\') OR (("registration_date" = \'2023-08-23\') AND ("approved" < 1)))))))))',
        '(course_id LIKE \'ALG%\') AND (("course_id" > \'ALG002  t0.\') OR (("course_id" = \'ALG002  t0.\') AND (("quarter_id" > 5678) OR (("quarter_id" = 5678) AND (("recd_timestamp" > \'2023-08-26T16:00:00\') OR (("recd_timestamp" = \'2023-08-26T16:00:00\') AND (("registration_date" > \'2023-08-23\') OR (("registration_date" = \'2023-08-23\') AND ("approved" >= 1))))))))) AND (("course_id" < \'ALG003\') OR (("course_id" = \'ALG003\') AND (("quarter_id" < 1234) OR (("quarter_id" = 1234) AND (("recd_timestamp" < \'2023-08-27T15:00:00\') OR (("recd_timestamp" = \'2023-08-27T15:00:00\') AND (("registration_date" < \'1969-07-20\') OR (("registration_date" = \'1969-07-20\') AND ("approved" < 0)))))))))',
        '(course_id LIKE \'ALG%\') AND (("course_id" > \'ALG003\') OR (("course_id" = \'ALG003\') AND (("quarter_id" > 1234) OR (("quarter_id" = 1234) AND (("recd_timestamp" > \'2023-08-27T15:00:00\') OR (("recd_timestamp" = \'2023-08-27T15:00:00\') AND (("registration_date" > \'1969-07-20\') OR (("registration_date" = \'1969-07-20\') AND ("approved" >= 0))))))))) AND (("course_id" < \'ALG003\') OR (("course_id" = \'ALG003\') AND (("quarter_id" < 5678) OR (("quarter_id" = 5678) AND (("recd_timestamp" < \'2023-08-27T15:00:00\') OR (("recd_timestamp" = \'2023-08-27T15:00:00\') AND (("registration_date" < \'1969-07-20\') OR (("registration_date" = \'1969-07-20\') AND ("approved" < 0)))))))))',
        '(course_id LIKE \'ALG%\') AND (("course_id" > \'ALG003\') OR (("course_id" = \'ALG003\') AND (("quarter_id" > 5678) OR (("quarter_id" = 5678) AND (("recd_timestamp" > \'2023-08-27T15:00:00\') OR (("recd_timestamp" = \'2023-08-27T15:00:00\') AND (("registration_date" > \'1969-07-20\') OR (("registration_date" = \'1969-07-20\') AND ("approved" >= 0))))))))) AND (("course_id" < \'ALG004\') OR (("course_id" = \'ALG004\') AND (("quarter_id" < 1234) OR (("quarter_id" = 1234) AND (("recd_timestamp" < \'2023-08-27T15:00:00\') OR (("recd_timestamp" = \'2023-08-27T15:00:00\') AND (("registration_date" < \'1969-07-20\') OR (("registration_date" = \'1969-07-20\') AND ("approved" < 0)))))))))',
        '(course_id LIKE \'ALG%\') AND (("course_id" > \'ALG004\') OR (("course_id" = \'ALG004\') AND (("quarter_id" > 1234) OR (("quarter_id" = 1234) AND (("recd_timestamp" > \'2023-08-27T15:00:00\') OR (("recd_timestamp" = \'2023-08-27T15:00:00\') AND (("registration_date" > \'1969-07-20\') OR (("registration_date" = \'1969-07-20\') AND ("approved" >= 0))))))))) AND (("course_id" < \'ALG004\') OR (("course_id" = \'ALG004\') AND (("quarter_id" < 5678) OR (("quarter_id" = 5678) AND (("recd_timestamp" < \'2023-08-27T15:00:00\') OR (("recd_timestamp" = \'2023-08-27T15:00:00\') AND (("registration_date" < \'1969-07-20\') OR (("registration_date" = \'1969-07-20\') AND ("approved" < 0)))))))))',
        '(course_id LIKE \'ALG%\') AND (("course_id" > \'ALG004\') OR (("course_id" = \'ALG004\') AND (("quarter_id" > 5678) OR (("quarter_id" = 5678) AND (("recd_timestamp" > \'2023-08-27T15:00:00\') OR (("recd_timestamp" = \'2023-08-27T15:00:00\') AND (("registration_date" > \'1969-07-20\') OR (("registration_date" = \'1969-07-20\') AND ("approved" >= 0)))))))))',
    ],
    [
        '(course_id LIKE \'ALG%\') AND (("course_id" < \'ALG001\') OR (("course_id" = \'ALG001\') AND (("quarter_id" < 1234) OR (("quarter_id" = 1234) AND (("recd_timestamp" < \'2023-08-26T16:00:00\') OR (("recd_timestamp" = \'2023-08-26T16:00:00\') AND (("registration_date" < \'2023-08-23\') OR (("registration_date" = \'2023-08-23\') AND ("approved" < 1)))))))))',
        '(course_id LIKE \'ALG%\') AND (("course_id" > \'ALG001\') OR (("course_id" = \'ALG001\') AND (("quarter_id" > 1234) OR (("quarter_id" = 1234) AND (("recd_timestamp" > \'2023-08-26T16:00:00\') OR (("recd_timestamp" = \'2023-08-26T16:00:00\') AND (("registration_date" > \'2023-08-23\') OR (("registration_date" = \'2023-08-23\') AND ("approved" >= 1))))))))) AND (("course_id" < \'ALG001\') OR (("course_id" = \'ALG001\') AND (("quarter_id" < 5678) OR (("quarter_id" = 5678) AND (("recd_timestamp" < \'2023-08-26T16:00:00\') OR (("recd_timestamp" = \'2023-08-26T16:00:00\') AND (("registration_date" < \'2023-08-23\') OR (("registration_date" = \'2023-08-23\') AND ("approved" < 1)))))))))',
...
def test_generate_partitions(tmp_path: pathlib.Path):
    ...
    Have to limit testing to rows not containing strings with embedded quotes due to issue 1221"""
    partition_table_test(
        EXPECTED_PARTITION_FILTER,
