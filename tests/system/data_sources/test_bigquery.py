...
EXPECTED_PARTITION_FILTER = [
    [
        " (quarter_id != 1111) AND ((`course_id` < 'ALG001') OR ((`course_id` = 'ALG001') AND ((`quarter_id` < 5678) OR ((`quarter_id` = 5678) AND ((`registration_date` < DATE '2023-08-23') OR ((`registration_date` = DATE '2023-08-23') AND (`approved` < TRUE)))))))",
        " (quarter_id != 1111) AND ((`course_id` > 'ALG001') OR ((`course_id` = 'ALG001') AND ((`quarter_id` > 5678) OR ((`quarter_id` = 5678) AND ((`registration_date` > DATE '2023-08-23') OR ((`registration_date` = DATE '2023-08-23') AND (`approved` >= TRUE))))))) AND ((`course_id` < 'ALG002  t0.') OR ((`course_id` = 'ALG002  t0.') AND ((`quarter_id` < 5678) OR ((`quarter_id` = 5678) AND ((`registration_date` < DATE '2023-08-23') OR ((`registration_date` = DATE '2023-08-23') AND (`approved` < TRUE)))))))",
        " (quarter_id != 1111) AND ((`course_id` > 'ALG002  t0.') OR ((`course_id` = 'ALG002  t0.') AND ((`quarter_id` > 5678) OR ((`quarter_id` = 5678) AND ((`registration_date` > DATE '2023-08-23') OR ((`registration_date` = DATE '2023-08-23') AND (`approved` >= TRUE))))))) AND ((`course_id` < 'ALG003') OR ((`course_id` = 'ALG003') AND ((`quarter_id` < 5678) OR ((`quarter_id` = 5678) AND ((`registration_date` < DATE '2023-08-23') OR ((`registration_date` = DATE '2023-08-23') AND (`approved` < FALSE)))))))",
        " (quarter_id != 1111) AND ((`course_id` > 'ALG003') OR ((`course_id` = 'ALG003') AND ((`quarter_id` > 5678) OR ((`quarter_id` = 5678) AND ((`registration_date` > DATE '2023-08-23') OR ((`registration_date` = DATE '2023-08-23') AND (`approved` >= FALSE))))))) AND ((`course_id` < 'ALG004') OR ((`course_id` = 'ALG004') AND ((`quarter_id` < 5678) OR ((`quarter_id` = 5678) AND ((`registration_date` < DATE '2023-08-23') OR ((`registration_date` = DATE '2023-08-23') AND (`approved` < FALSE)))))))",
        " (quarter_id != 1111) AND ((`course_id` > 'ALG004') OR ((`course_id` = 'ALG004') AND ((`quarter_id` > 5678) OR ((`quarter_id` = 5678) AND ((`registration_date` > DATE '2023-08-23') OR ((`registration_date` = DATE '2023-08-23') AND (`approved` >= FALSE))))))) AND ((`course_id` < 'St. Edward\\'\\'s') OR ((`course_id` = 'St. Edward\\'\\'s') AND ((`quarter_id` < 1234) OR ((`quarter_id` = 1234) AND ((`registration_date` < DATE '1969-07-20') OR ((`registration_date` = DATE '1969-07-20') AND (`approved` < TRUE)))))))",
        " (quarter_id != 1111) AND ((`course_id` > 'St. Edward\\'\\'s') OR ((`course_id` = 'St. Edward\\'\\'s') AND ((`quarter_id` > 1234) OR ((`quarter_id` = 1234) AND ((`registration_date` > DATE '1969-07-20') OR ((`registration_date` = DATE '1969-07-20') AND (`approved` >= TRUE))))))) AND ((`course_id` < 'St. John\\'\\'s') OR ((`course_id` = 'St. John\\'\\'s') AND ((`quarter_id` < 1234) OR ((`quarter_id` = 1234) AND ((`registration_date` < DATE '1969-07-20') OR ((`registration_date` = DATE '1969-07-20') AND (`approved` < TRUE)))))))",
        " (quarter_id != 1111) AND ((`course_id` > 'St. John\\'\\'s') OR ((`course_id` = 'St. John\\'\\'s') AND ((`quarter_id` > 1234) OR ((`quarter_id` = 1234) AND ((`registration_date` > DATE '1969-07-20') OR ((`registration_date` = DATE '1969-07-20') AND (`approved` >= TRUE))))))) AND ((`course_id` < 'St. Jude\\'\\'s') OR ((`course_id` = 'St. Jude\\'\\'s') AND ((`quarter_id` < 1234) OR ((`quarter_id` = 1234) AND ((`registration_date` < DATE '1969-07-20') OR ((`registration_date` = DATE '1969-07-20') AND (`approved` < FALSE)))))))",
        " (quarter_id != 1111) AND ((`course_id` > 'St. Jude\\'\\'s') OR ((`course_id` = 'St. Jude\\'\\'s') AND ((`quarter_id` > 1234) OR ((`quarter_id` = 1234) AND ((`registration_date` > DATE '1969-07-20') OR ((`registration_date` = DATE '1969-07-20') AND (`approved` >= FALSE))))))) AND ((`course_id` < 'St. Paul\\'\\'s') OR ((`course_id` = 'St. Paul\\'\\'s') AND ((`quarter_id` < 1234) OR ((`quarter_id` = 1234) AND ((`registration_date` < DATE '1969-07-20') OR ((`registration_date` = DATE '1969-07-20') AND (`approved` < FALSE)))))))",
        " (quarter_id != 1111) AND ((`course_id` > 'St. Paul\\'\\'s') OR ((`course_id` = 'St. Paul\\'\\'s') AND ((`quarter_id` > 1234) OR ((`quarter_id` = 1234) AND ((`registration_date` > DATE '1969-07-20') OR ((`registration_date` = DATE '1969-07-20') AND (`approved` >= FALSE)))))))",
    ],
    [
        " (quarter_id != 1111) AND ((`course_id` < 'ALG001') OR ((`course_id` = 'ALG001') AND ((`quarter_id` < 5678) OR ((`quarter_id` = 5678) AND ((`registration_date` < DATE '2023-08-23') OR ((`registration_date` = DATE '2023-08-23') AND (`approved` < TRUE)))))))",
        " (quarter_id != 1111) AND ((`course_id` > 'ALG001') OR ((`course_id` = 'ALG001') AND ((`quarter_id` > 5678) OR ((`quarter_id` = 5678) AND ((`registration_date` > DATE '2023-08-23') OR ((`registration_date` = DATE '2023-08-23') AND (`approved` >= TRUE))))))) AND ((`course_id` < 'ALG002  t0.') OR ((`course_id` = 'ALG002  t0.') AND ((`quarter_id` < 5678) OR ((`quarter_id` = 5678) AND ((`registration_date` < DATE '2023-08-23') OR ((`registration_date` = DATE '2023-08-23') AND (`approved` < TRUE)))))))",
