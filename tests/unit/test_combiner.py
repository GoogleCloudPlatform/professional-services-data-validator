            ...
            pandas.DataFrame(
                {
                    ...
                    "source_connection": ["source_conn"] * 6,
                    "target_table_name": [
                        "bq-public.target_dataset.test_target",
                        "bq-public.target_dataset.test_target",
                        "bq-public.target_dataset.test_target",
                    ...
                    "target_connection": ["target_conn"] * 6,
