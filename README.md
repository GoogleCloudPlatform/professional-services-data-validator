...
(Note: Custom query row validation is currently only supported for BigQuery, Teradata, SQL Server, PostgreSQL, AlloyDB, and Impala/Hive, Oracle. Struct and array data types are not currently supported.)
