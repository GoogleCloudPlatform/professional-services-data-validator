...
- calculated_fields:
  - depth: 0
    ...
    - start_time
    type: custom
    ibis_expr: ibis.expr.types.TimestampValue.strftime
    params:
    - format_str: '%m%d%Y'
```

The above block references the [TimestampValue.strftime](https://ibis-project.org/reference/expressions/timestamps) Ibis API expression.
